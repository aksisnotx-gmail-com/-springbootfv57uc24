<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230831/8f759c98d11c4576b7648b4b03eff370.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #f6f6f6","padding":"20px 20px 20px","boxShadow":"0 0px 0px rgba(0, 0, 0, .2)","margin":"0 auto 0 50%","borderRadius":"0px","textAlign":"center","background":"none","width":"40%","fontSize":"16px","position":"relative","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"0px auto 30px","borderColor":"#ddd","color":"#38567a","background":"none","borderWidth":"0px","display":"inline-block","width":"100%","lineHeight":"auto","fontSize":"26px","borderStyle":"solid","fontWeight":"600"}' class="title-container">公司部门业务审批管理系统登录</div>
        ...
        <div :style='{"margin":"20px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"50%","fontSize":"16px","position":"relative","justifyContent":"flex-start"}'>
          <el-button v-if="loginType==1" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 0 0 20px","margin":"0 0 20px","color":"#fff","textAlign":"center","letterSpacing":"10px","outline":"none","borderRadius":"0px","background":"#2b2f30","width":"100%","fontSize":"18px","height":"44px"}' type="primary" @click="login()" class="loginInBt">登录</el-button>
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 8px","margin":"0 5px 10px","borderColor":"rgba(167,142,68,1)","color":"#333","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0px","width":"auto","fontSize":"inherit","borderStyle":"solid","fontWeight":"500","height":"40px"}' type="primary" @click="register('yuangong')" class="register">注册技术部门员工</el-button>
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 8px","margin":"0 5px 10px","borderColor":"rgba(167,142,68,1)","color":"#333","outline":"none","borderRadius":"0px","background":"none","borderWidth":"0px","width":"auto","fontSize":"inherit","borderStyle":"solid","fontWeight":"500","height":"40px"}' type="primary" @click="register('zhuguan')" class="register">注册技术部门经理</el-button>
        </div>
      </el-form>
	...
	setVerify() {
		...
		this.$nextTick(() => {
			$('#option1').slideVerify({
				...
				vSpace: 5, //间隔
				imgName: [{"name":"01.jpg","uid":1691481369814,"url":"http://codegen.caihongy.cn/20230808/848ced764668429ba80d81d3fd67e056.jpg","status":"success"},{"name":"02.jpg","uid":1691481372476,"url":"http://codegen.caihongy.cn/20230808/2a2690120251490094ccdaa6bc922f10.jpg","status":"success"},{"name":"03.jpg","uid":1691481375135,"url":"http://codegen.caihongy.cn/20230808/487cf76641c64cfb8050bb7861f04979.jpg","status":"success"}].map((item)=>{return item.url}),
...
.container {
  ...
  background-size: cover;
      background: url(http://codegen.caihongy.cn/20230831/8f759c98d11c4576b7648b4b03eff370.jpg);
