	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","color":"#666","background":"#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="select" v-if="type!='info'"  label="技术部门经理工号" prop="zhuguangonghao">
					<el-select :disabled="ro.zhuguangonghao" v-model="ruleForm.zhuguangonghao" placeholder="请选择技术部门经理工号" >
						<el-option
							v-for="(item,index) in zhuguangonghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else class="input" label="技术部门经理工号" prop="zhuguangonghao">
					<el-input v-model="ruleForm.zhuguangonghao"
						placeholder="技术部门经理工号" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/zhuguan/zhuguangonghao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.zhuguangonghaoOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
