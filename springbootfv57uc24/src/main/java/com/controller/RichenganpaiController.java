...
public class RichenganpaiController {
    ...
    public R page(@RequestParam Map<String, Object> params,RichenganpaiEntity richenganpai,
		...
		if(tableName.equals("yuangong")) {
			richenganpai.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("zhuguan")) {
			richenganpai.setZhuguangonghao((String)request.getSession().getAttribute("username"));
		}
